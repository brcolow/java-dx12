...
jextract --source -d src/main/java -t com.dx12 -I "$I\um" -I "$I\shared" -C "-DWIN32_LEAN_AND_MEAN" -- "$I\um\Windows.h"
# jextract --source -d . -t com.dx12 -I "$I\shared" -I "$I\um" -C "-DWIN32_LEAN_AND_MEAN=1" -C "-D_AMD64_=1" -- "$I\um\WinUser.h"
jextract --source -d src/main/java -t com.dx12 -I "$I\um" --filter "d3d12.h" -- "$I\um\d3d12.h"
jextract --source -d src/main/java -t com.dx12 -I "$I\um" --filter "d3dcommon.h" -- "$I\um\d3dcommon.h"
jextract --source -d src/main/java -t com.dx12 -I "$I\um" --filter "dxgi.h" -- "$I\shared\dxgi.h"
